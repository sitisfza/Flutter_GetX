        ...
        child: Column(
          children: [
            CircleAvatar(
              radius: 50,
              backgroundImage:
                  NetworkImage('https://static.vecteezy.com/system/resources/thumbnails/007/033/146/small_2x/profile-icon-login-head-icon-vector.jpg'),
            ),
            Container(
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  "My name is SITI SALIMAH AL FAZA. I'm a developer from Bandung, Indonesia. I created an application using the Flutter framework and the Dart programming language.",
